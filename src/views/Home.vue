<template>
  <div>
    ...
    <div class="flex justify-end top-30 right-1 z-50 bg-white p-2">
    ...
    <div class="row flex">
      ...
      <div class="container mx-auto top-80">
        ...
        <div
          v-if="style == 0"
          class="top-10 grid grid-cols-1 gap-6 sm:grid-cols-3 sm:gap-2 md:grid-cols-4 lg:grid-cols-5 lg:gap-3"
        >
          <div
          ...
          >
            <img
              class="block mx-auto lg:h-18 md:h-10 rounded-full sm:mx-0 sm:shrink-0 sm:h-8"
            ...
            <div class="text-center space-y-2 sm:text-left">
              <div class="space-y-0.5">
                <p
                  class="text-lg text-black lg:font-semibold md:text-lg sm:text-sm"
                >
                  {{ user.name.last }}
                </p>

                <p class="text-gray-500 font-medium width--15">
                  {{ user.id.value !== null ? user.id.value : ' ' }}
                </p>
              </div>
              <button
                @click="dialog = true"
                class="sm:px-0 md:px-1 px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2"
              >
                Message
              </button>
            </div>
